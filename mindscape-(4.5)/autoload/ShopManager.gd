...
const SHOP_CATALOG = {
	...
	# ===== ROOM DECORATIONS =====
	# Free collectibles found on the ship (tutorial items)
	"decor_ship_memento": {
		"name": "Ship Memento",
		"description": "A small keepsake from the Stellar Wanderer. Reminds you of home.",
		"category": ItemCategory.ROOM_DECOR,
		"rarity": ItemRarity.COMMON,
		"cost": {},  # Free - found on ship
		"size": Vector2(30, 30),
		"placement_type": "floor",
		"free_collectible": true
	},
	"decor_family_photo": {
		"name": "Family Photo",
		"description": "A holographic photo of your family. Mom and Dad smile warmly.",
		"category": ItemCategory.ROOM_DECOR,
		"rarity": ItemRarity.COMMON,
		"cost": {},  # Free - found on ship
		"size": Vector2(35, 45),
